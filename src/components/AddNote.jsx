  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (isEditing) {
        ...
        await axios.put(`http://52.66.237.19:5000/api/notes/${noteForEdit._id}`, { activeindicator, content });
        Swal.fire({
          icon: "success",
        ...
        await axios.post('http://52.66.237.19:5000/api/notes', { activeindicator, content });
        Swal.fire({
          icon: "success",
