...
function MarketPlace() {
  ...
  useEffect(() => {
    const fetchOptions = async () => {
      try {
        // Fetch categories
        const categoriesResponse = await axios.get('http://52.66.237.19:5000/api/category'); // Adjust URL as needed
    ...
    const fetchNotes = async () => {
      const notesres = await axios.get('http://52.66.237.19:5000/api/notes')
