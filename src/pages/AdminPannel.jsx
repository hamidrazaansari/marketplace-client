...
function AdminPannel({handleRenderAddSites , siteForEdit }) {
  ...
  useEffect(() => {
    const fetchOptions = async () => {
      try {
        const categoriesResponse = await axios.get('http://52.66.237.19:5000/api/category');
        ...
        const languagesResponse = await axios.get('http://52.66.237.19:5000/api/languages');
        ...
        const countryResponse = await axios.get('http://52.66.237.19:5000/api/country');
        ...
        const nicheResponse = await axios.get('http://52.66.237.19:5000/api/niche');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (isEditing) {
        await axios.put(`http://52.66.237.19:5000/api/data/${siteForEdit._id}`, formData);
        Swal.fire({
          icon: "success",
        ...
        await axios.post('http://52.66.237.19:5000/api/data', formData);
        Swal.fire({
          icon: "success",
  ...
  const handleBulkDataSubmit = async () => {
    try {
      await axios.post('http://52.66.237.19:5000/api/bulkData', bulkData);
      Swal.fire({
        icon: "success",
